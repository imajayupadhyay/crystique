    ...
    <div class="pt-36 pb-20 bg-gray-50">
      <div class="container mx-auto px-6">
        ...
        <div v-if="cartItems.length === 0" class="flex flex-col items-center justify-center py-20">
          <div class="w-32 h-32 border border-gray-300 flex items-center justify-center mb-6">
          ...
          <Link href="/products" class="px-8 py-4 bg-gray-900 text-white text-xs tracking-[0.15em] uppercase font-medium hover:bg-gray-800 transition-colors">
            Start Shopping
          </Link>
        </div>
          ...
          <div class="lg:col-span-2">
            <div class="bg-white border border-gray-300">
              <div class="p-6 border-b border-gray-300">
                <h2 class="text-xl font-medium text-gray-900 tracking-wide uppercase">Cart Items</h2>
              </div>
                  ...
                  <div class="flex gap-6">
                    ...
                    <Link :href="`/products/${item.categorySlug}/${item.slug}`" class="flex-shrink-0">
                      <img
                        :src="item.image"
                        :alt="item.name"
                        class="w-32 h-32 object-cover hover:opacity-75 transition-opacity"
                      />
                    </Link>
                    ...
                    <div class="flex-1 min-w-0">
                      <div class="flex justify-between items-start mb-2">
                        <div>
                          <Link :href="`/products/${item.categorySlug}/${item.slug}`">
                            <h3 class="text-lg font-medium text-gray-900 hover:text-gray-700 transition-colors line-clamp-2">
                              {{ item.name }}
                            </h3>
                          </Link>
                          <p class="text-sm text-gray-600 mt-1">{{ item.category }}</p>
                          <div v-if="item.badge" class="inline-block mt-2 px-3 py-1 bg-gray-900 text-white text-xs font-medium uppercase tracking-wider">
                            {{ item.badge }}
                          </div>
                        </div>
                        ...
                        <div class="lg:hidden text-right">
                          <div class="text-xl font-medium text-gray-900">₹{{ item.price * item.quantity }}</div>
                        ...
                        <div class="flex items-center gap-3">
                          ...
                          <div class="flex items-center border border-gray-300">
                            ...
                            <input
                              ...
                              type="number"
                              min="1"
                              class="w-16 text-center border-x border-gray-300 py-2 focus:outline-none font-medium"
                            />
                            <button
                              @click="updateQuantity(item.id, item.quantity + 1)"
                              class="px-4 py-2 hover:bg-gray-100 transition-colors"
                      ...
                      <button
                        ...
                        class="mt-4 flex items-center gap-2 text-gray-700 hover:text-gray-900 font-medium transition-colors text-sm uppercase tracking-wider"
                      >
            ...
            <!-- Continue Shopping -->
            <div class="mt-6">
              <Link href="/products" class="inline-flex items-center gap-2 text-gray-700 hover:text-gray-900 font-medium transition-colors text-sm uppercase tracking-wider">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div class="lg:col-span-1">
            <div class="bg-white border border-gray-300 p-6 sticky top-28">
              ...
              <div class="space-y-4 mb-6">
                ...
                <div v-if="cartTotal < 2000" class="pt-4 border-t border-gray-300">
                  ...
                  <div class="w-full bg-gray-200 h-2">
                    <div
                      class="bg-gray-900 h-2 transition-all duration-300"
                      :style="{ width: `${Math.min((cartTotal / 2000) * 100, 100)}%` }"
                    ></div>
                  </div>
                </div>
                <div v-else class="pt-4 border-t border-gray-300">
              ...
              <Link
                href="/checkout"
                class="w-full px-6 py-4 bg-gray-900 text-white text-xs tracking-[0.15em] uppercase font-medium hover:bg-gray-800 transition-colors flex items-center justify-center gap-2 mb-3"
              >
