  ...
  <section class="py-20 bg-gray-900">
    <div class="container mx-auto px-6">
      <div class="text-center mb-16">
        <h2 class="text-3xl md:text-4xl font-serif tracking-[0.2em] text-white mb-4 uppercase">
          Our Impact in Numbers
        </h2>
        <p class="text-gray-400">Growing together with our community</p>
      </div>

      <div class="grid grid-cols-2 lg:grid-cols-4 gap-8">
        <div class="text-center">
          <div class="w-16 h-16 border border-gray-700 flex items-center justify-center mx-auto mb-4">
        ...
        <div class="text-center">
          ...
          <div class="text-gray-400">Unique Products</div>
        </div>
